...
- Branch-only (`resolve-issue-clear-data-scope`): Settings → Clear Data removes requests through `HiveHandler.clear()` and preserves environments, history, Dashbot data, and shared preferences.
